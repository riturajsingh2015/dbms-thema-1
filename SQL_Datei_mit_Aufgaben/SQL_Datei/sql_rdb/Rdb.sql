--  Rdb.sql  zwei Tabellen books and authors erstellt und dann fügt einige Daten in sie ein. 
--  Diese SQL-Datei dient nur dazu, sich mit den Konzepten relationaler Datenbanken 
--  und einfacher SQL-Abfragen vertraut zu machen
...
--   Sie können eine der folgenden Abfragen auskommentieren, um die Ergebnisse zu sehen
--  SELECT * FROM authors;
